...
import { CodeMetadata, SASCodeDocumentOptions } from "./SASCodeDocument";
...
): { metadata: CodeMetadata; options: SASCodeDocumentOptions } {
  return {
    metadata: constructCodeMetadata(textDocument, addition?.selections),
    options: constructSASCodeDocumentOptions(textDocument, addition),
  };
}
...
function constructCodeMetadata(
  textDocument: TextDocument,
  selections?: ReadonlyArray<Selection>,
): CodeMetadata {
  return {
    ...
    selectedCode: getSelectedCode(textDocument, selections),
...
function constructSASCodeDocumentOptions(
  textDocument: TextDocument,
  addition?: {
    selections?: ReadonlyArray<Selection>;
    preamble?: string;
