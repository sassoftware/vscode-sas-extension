...
export class SetupConnectionResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: SetupConnectionResponse
  ): SetupConnectionResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class ConnectionContext extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ConnectionContext
  ): ConnectionContext.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class CloseConnectionResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: CloseConnectionResponse
  ): CloseConnectionResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class FileChunk extends jspb.Message {
  ...
  setChunk(value: Uint8Array | string): FileChunk;
