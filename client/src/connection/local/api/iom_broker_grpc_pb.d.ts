...
interface IExecutionServiceService
  ...
  fetchODS: IExecutionServiceService_IFetchODS;
}

interface IExecutionServiceService_ISetupConnection
  extends grpc.MethodDefinition<
    iom_broker_pb.ConnectionContext,
    iom_broker_pb.SetupConnectionResponse
  > {
...
interface IExecutionServiceService_IExecuteCode
  extends grpc.MethodDefinition<
    iom_broker_pb.ExecutionRequest,
    iom_broker_pb.ExecutionResponse
  > {
...
interface IExecutionServiceService_ICloseConnection
  extends grpc.MethodDefinition<
    google_protobuf_empty_pb.Empty,
    iom_broker_pb.CloseConnectionResponse
  > {
...
interface IExecutionServiceService_IFetchLog
  extends grpc.MethodDefinition<
    google_protobuf_empty_pb.Empty,
    iom_broker_pb.LogChunk
  > {
...
interface IExecutionServiceService_IFetchODS
  extends grpc.MethodDefinition<
    google_protobuf_empty_pb.Empty,
    iom_broker_pb.FileChunk
  > {
  ...
  requestSerialize: grpc.serialize<google_protobuf_empty_pb.Empty>;
  requestDeserialize: grpc.deserialize<google_protobuf_empty_pb.Empty>;
  responseSerialize: grpc.serialize<iom_broker_pb.FileChunk>;
  responseDeserialize: grpc.deserialize<iom_broker_pb.FileChunk>;
}
...
export interface IExecutionServiceServer
  ...
  setupConnection: grpc.handleUnaryCall<
    iom_broker_pb.ConnectionContext,
    iom_broker_pb.SetupConnectionResponse
  >;
  executeCode: grpc.handleUnaryCall<
    iom_broker_pb.ExecutionRequest,
    iom_broker_pb.ExecutionResponse
  >;
  closeConnection: grpc.handleUnaryCall<
    google_protobuf_empty_pb.Empty,
    iom_broker_pb.CloseConnectionResponse
  >;
  fetchLog: grpc.handleServerStreamingCall<
    google_protobuf_empty_pb.Empty,
    iom_broker_pb.LogChunk
  >;
  fetchODS: grpc.handleServerStreamingCall<
    google_protobuf_empty_pb.Empty,
    iom_broker_pb.FileChunk
  >;
}
...
export interface IExecutionServiceClient {
  setupConnection(
    request: iom_broker_pb.ConnectionContext,
    callback: (
      error: grpc.ServiceError | null,
      response: iom_broker_pb.SetupConnectionResponse
    ) => void
  ...
  executeCode(
    request: iom_broker_pb.ExecutionRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: iom_broker_pb.ExecutionResponse
    ) => void
  ): grpc.ClientUnaryCall;
  executeCode(
    request: iom_broker_pb.ExecutionRequest,
  ...
  closeConnection(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: iom_broker_pb.CloseConnectionResponse
    ) => void
  ): grpc.ClientUnaryCall;
  closeConnection(
    request: google_protobuf_empty_pb.Empty,
  ...
  fetchLog(
    request: google_protobuf_empty_pb.Empty,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<iom_broker_pb.LogChunk>;
  fetchLog(
    request: google_protobuf_empty_pb.Empty,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
  ...
  fetchODS(
    request: google_protobuf_empty_pb.Empty,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<iom_broker_pb.FileChunk>;
  fetchODS(
    request: google_protobuf_empty_pb.Empty,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
