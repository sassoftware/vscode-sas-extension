...
function serialize_iomBroker_CloseConnectionResponse(arg) {
  if (!(arg instanceof iom_broker_pb.CloseConnectionResponse)) {
    throw new Error('Expected argument of type iomBroker.CloseConnectionResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_iomBroker_CloseConnectionResponse(buffer_arg) {
  return iom_broker_pb.CloseConnectionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_iomBroker_ConnectionContext(buffer_arg) {
  return iom_broker_pb.ConnectionContext.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_iomBroker_ExecutionRequest(buffer_arg) {
  return iom_broker_pb.ExecutionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_iomBroker_ExecutionResponse(buffer_arg) {
  return iom_broker_pb.ExecutionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_iomBroker_SetupConnectionResponse(arg) {
  if (!(arg instanceof iom_broker_pb.SetupConnectionResponse)) {
    throw new Error('Expected argument of type iomBroker.SetupConnectionResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_iomBroker_SetupConnectionResponse(buffer_arg) {
  return iom_broker_pb.SetupConnectionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
exports.ExecutionServiceClient = grpc.makeGenericClientConstructor(ExecutionServiceService);
