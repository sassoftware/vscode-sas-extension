...
describe("convert notebook to code list", () => {
  it("convert the multi cell notebook to code list correctly", async () => {
    const codeList = generateCodeListFromNotebook(
      contentNotebook1
        .replace(/\n/g, "\\n")
        .replace(/\t/g, "\\t")
        .replace(/\r/g, "\\r"),
  ...
  it("convert the one cell notebook to code list correctly", async () => {
    const codeList = generateCodeListFromNotebook(
      contentNotebook2
        .replace(/\n/g, "\\n")
        .replace(/\t/g, "\\t")
