    ...
    const testCases: testCase[] = [
      {
        ...
        wantTitle: "Host",
        wantDescription: "Enter a Host",
        wantPlaceHolder: "Enter a Host",
      },
      {
        name: "SAS Path",
        prompt: ProfilePromptType.SASPath,
        wantTitle: "SAS Path Executable",
        wantDescription: "Enter the server path of a SAS Executable",
        wantPlaceHolder: "Enter the server path of a SAS Executable",
      },
      {
        name: "Port",
      ...
      },
      {
        ...
        wantTitle: "Username",
        wantDescription: "Enter a Username",
        wantPlaceHolder: "Enter a Username",
      },
      {
        name: "Private Key File",
        prompt: ProfilePromptType.PrivateKeyPath,
        wantTitle: "Private Key File",
        wantDescription: "Enter a local path to a Private Key File",
        wantPlaceHolder: "Enter a local path to a Private Key File",
      },
    ];
